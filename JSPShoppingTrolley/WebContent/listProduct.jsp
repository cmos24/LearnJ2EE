...
<script src="/JSPShoppingTrolley/js/jquery-3.2.1.min.js"></script>
...
$("input.addCartButton").click(function(){
	...
	var page = "/JSPShoppingTrolley/addOrderItem";
       $.get(
           page,
           {"num":number,"pid":pid},
           function(result){
...
<table align='center' border='1' cellspacing='0'>
    ...
    <c:forEach items="${products}" var="product" varStatus="st">
    	...
    	<tr>
    		<td colspan="4"><a href="/JSPShoppingTrolley/listOrderItem">查看购物车</a></td>
